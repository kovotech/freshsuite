MODULE_PATH="pipelines.accounts.recently_updated"
...
if __name__ == '__main__':
    try:
        ...
        job.multi_records(import_records=True,api_embeddings="owner,creater,updater")
        ...
        trigger_email(
                ...
                jobname="Recently Updated Accounts",
                exception=e
                )
