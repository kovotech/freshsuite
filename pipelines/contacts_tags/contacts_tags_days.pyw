...
from jobs.contacts_tags import contacts_tags_days
...
logger = JobLogger("Logs","Contacts Tags","recent")
...
if __name__ == '__main__':
    try:
        contacts_tags_days(days=DAYS,date_col=DATE_COLUMN)
        ...
        trigger_email(
                ...
                jobname=f"Contacts Tags Updated Since {DAYS}",
                exception=e
                )
