...
from jobs.deals_contacts import deals_contacts_days
...
logger = JobLogger("Logs","Deals Contacts","recent")
...
if __name__ == '__main__':
    try:
        deals_contacts_days(days=DAYS,date_col=DATE_COLUMN)
        ...
        trigger_email(
                ...
                jobname=f"Deals Contacts Updated Since {DAYS}",
                exception=e
                )
