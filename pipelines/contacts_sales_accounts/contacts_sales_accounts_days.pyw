...
from jobs.contacts_sales_accounts import contacts_sales_accounts_days
...
logger = JobLogger("Logs","Contacts Sales Accounts","recent")
...
if __name__ == '__main__':
    try:
        contacts_sales_accounts_days(days=DAYS,date_col=DATE_COLUMN)
        ...
        trigger_email(
                ...
                jobname="Contacts Recent Sales Accounts",
                exception=e
                )
