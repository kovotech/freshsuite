...
from jobs.contacts_sales_accounts import contacts_sales_accounts_all
...
logger = JobLogger("Logs","Contacts Sales Accounts","all")
log_path = logger.getPath()

if __name__ == '__main__':
    try:
        contacts_sales_accounts_all()
        ...
        trigger_email(
                ...
                jobname="Contacts All Sales Accounts",
                exception=e
                )
