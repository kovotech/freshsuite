...
from jobs.calls_integrated_resources import calls_integrated_resources_all
...
logger = JobLogger("Logs","Calls Integrated Resources","all")
log_path = logger.getPath()

if __name__ == '__main__':
    try:
        calls_integrated_resources_all()
        ...
        trigger_email(
                ...
                jobname="Calls All Integrated Resources",
                exception=e
                )
