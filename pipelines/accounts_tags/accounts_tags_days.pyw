...
from jobs.accounts_tags import accounts_tags_days
...
logger = JobLogger("Logs","Accounts Tags","recent")
...
if __name__ == '__main__':
    try:
        accounts_tags_days(days=DAYS,date_col=DATE_COLUMN)
        ...
        trigger_email(
                ...
                jobname=f"Accounts Tags Updated Since {DAYS}",
                exception=e
                )
